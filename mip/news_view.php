...
<head>
    ...
    <title><?= htmlspecialchars($news['title']) ?> — Новости МИП</title>
</head>
<body>
    <div class="screen">
        <div class="div">
            ...
            <article class="news-detail-container">
                ...
                <?php if (!empty($galleryImages)): ?>
                    <div class="news-gallery">
                        <h3 class="gallery-title">Фотографии</h3>
                ...
                <div class="news-detail-footer">
                    <a href="news.php" class="btn-back">Вернуться к списку новостей</a>
                </div>
            </article>
            
            <?php if (!isset($context)) { $context = 'mip'; } require_once '../footer.php'; ?>
        </div>
    </div>
